...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-10">Create New Formulir {{$namakriteria}}</button>
    @if (count($formulir)>0)
        <div class="py-10">
                                ...
                                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            <label for="kolomInput" class="block text-gray-700 text-sm font-bold mb-2">Nama Kolom:</label>
                                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="kolomInput" placeholder="Enter Kolom" wire:model="nama_penilaian">
                                            @error('nama_penilaian') <span class="text-red-500">{{ $message }}</span>@enderror
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            <label for="nilaiInput" class="block text-gray-700 text-sm font-bold mb-2">Nilai:</label>
                                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nilaiInput" placeholder="Enter Nilai" wire:model="nilai">
