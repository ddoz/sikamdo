...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    @endif
    <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-10">Create New Jadwal</button>
    @if (count($jadwals)>0)
        <div class="py-10">
                                ...
                                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            <label for="waktumulaiInput" class="block text-gray-700 text-sm font-bold mb-2">Waktu Mulai:</label>
                                            <input type="datetime-local" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="waktumulaiInput" placeholder="Enter Waktu Mulai" wire:model="waktu_mulai">
                                            @error('waktu_mulai') <span class="text-red-500">{{ $message }}</span>@enderror
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            <label for="waktuselesaiInput" class="block text-gray-700 text-sm font-bold mb-2">Waktu Selesai:</label>
                                            <input type="datetime-local" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="waktuselesaiInput" placeholder="Enter Waktu Mulai" wire:model="waktu_selesai">
                                            @error('waktu_selesai') <span class="text-red-500">{{ $message }}</span>@enderror
                                        </div>
                                    </div>
                                </div>
                                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
