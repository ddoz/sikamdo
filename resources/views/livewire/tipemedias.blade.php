...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    @endif
    <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-10">Create New Tipe Media</button>
    @if (count($tipemedias)>0)
        <div class="py-10">
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 bg-white text-sm @if (!$loop->last) border-gray-200 border-b @endif text-right">
                                    <div class="inline-block whitespace-no-wrap">
                                        <a href="{{route('formulir_buktitayang',['id'=>$tm->id])}}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Formulir Bukti Tayang</a>
                    ...
                    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="bg-white rounded-lg text-left overflow-hidden shadow-xl">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label for="namaInput" class="block text-gray-700 text-sm font-bold mb-2">Nama:</label>
                                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="namaInput" placeholder="Enter Nama" wire:model="nama">
